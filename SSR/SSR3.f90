...
!================================================================================================!
	subroutine depo		!!aqui ocorre as deposições ## cara aqui é o coração do programa ###
		...
		if(((S(a)-S(VD(a)))<=1).and.((S(a)-S(VE(a)))<=1)) then
