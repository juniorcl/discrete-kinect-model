module globalSSR
	...
	subroutine arquivos !!arquivos que aparecerão
		...
		if(L==128) then					
			open(1,file='perfilSSRL=128mol=50000Lamo=10000.dat')
			open(2,file='wSSRL=128mol=50000Lamo=10000.dat')
		else if(L==256) then
			...
			open(1,file='perfilSSRL=10000mol=500000Lamo=10000.dat')
			open(2,file='wSSRL=10000mol=500000Lamo=10000.dat')
		end if
