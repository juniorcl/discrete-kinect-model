module globalDB
	...
	subroutine arquivos !!arquivos que aparecerão
		...
		if(L==1408) then					
			open(1,file='perfilDBL=1408mol=50000Lamo=10000.dat')
			open(2,file='wDBL=1408mol=50000Lamo=10000.dat')
		else if(L==1536) then
			open(1,file='perfilDBL=1536mol=50000Lamo=10000.dat')
			open(2,file='wDBL=1536mol=50000Lamo=10000.dat')
		else if(L==1664) then
			open(1,file='perfilDBL=1664mol=50000Lamo=10000.dat')
			open(2,file='wDBL=1664mol=50000Lamo=10000.dat')
		else if(L==1792) then
			open(1,file='perfilDBL=1792mol=50000Lamo=10000.dat')
			open(2,file='wDBL=1792mol=50000Lamo=10000.dat')
		else if(L==1928) then
			open(1,file='perfilDBL=1928mol=50000Lamo=10000.dat')
			open(2,file='wDBL=1928mol=50000Lamo=10000.dat')
		end if
