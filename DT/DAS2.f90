module globalDAS
	...
	subroutine arquivos !!arquivos que aparecerão
		...
		if(L==768) then
			open(1,file='perfilDASL=768mol=100000Lamo=100000.dat')
			open(2,file='wDASL=768mol=100000Lamo=100000.dat')
		else if(L==896) then
			open(1,file='perfilDASL=896mol=100000Lamo=100000.dat')
			open(2,file='wDASL=896mol=100000Lamo=100000.dat')
		else if(L==1024) then
			open(1,file='perfilDASL=1024mol=100000Lamo=100000.dat')
			open(2,file='wDASL=1024mol=100000Lamo=100000.dat')
		else if(L==1152) then
			open(1,file='perfilDASL=1152mol=100000Lamo=100000.dat')
			open(2,file='wDASL=1152mol=100000Lamo=100000.dat')
		else if(L==1280) then
			open(1,file='perfilDASL=1280mol=100000Lamo=100000.dat')
			open(2,file='wDASL=1280mol=100000Lamo=100000.dat')
		end if
