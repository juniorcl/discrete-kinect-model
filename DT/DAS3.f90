module globalDAS
	...
	subroutine arquivos !!arquivos que aparecerão
		...
		if(L==2048) then
			open(1,file='perfilDASL=2048mol=160000Lamo=100000.dat')
			open(2,file='wDASL=2048mol=160000Lamo=100000.dat')
		else if(L==2176) then
			open(1,file='perfilDASL=2176mol=160000Lamo=100000.dat')
			open(2,file='wDASL=2176mol=160000Lamo=100000.dat')
		else if(L==2304) then
			open(1,file='perfilDASL=2304mol=160000Lamo=100000.dat')
			open(2,file='wDASL=2304mol=160000Lamo=100000.dat')
		else if(L==2432) then
			open(1,file='perfilDASL=2432mol=160000Lamo=100000.dat')
			open(2,file='wDASL=2432mol=160000Lamo=100000.dat')
		else if(L==2560) then
			open(1,file='perfilDASL=2560mol=160000Lamo=100000.dat')
			open(2,file='wDASL=2560mol=160000Lamo=100000.dat')
		end if
