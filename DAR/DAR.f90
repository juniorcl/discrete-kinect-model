module globalDAR
	...
	subroutine arquivos !!arquivos que aparecerão
		...
		if(L==128) then					
			...
			open(2,file='w/alfawDARL=256mol=100000Lamo=1000000/z.dat')
		else if(L==384) then
			!open(1,file='perfilDARL=384mol=100000Lamo=1000000.dat')
			open(2,file='w/alfawDARL=384mol=100000Lamo=1000000/z.dat')
		else if(L==512) then
			!open(1,file='perfilDARL=512mol=100000Lamo=1000000.dat')
			open(2,file='w/alfawDARL=512mol=100000Lamo=100000/z.dat')
		else if(L==640) then
			!open(1,file='perfilDARL=640mol=100000Lamo=1000000.dat')
			open(2,file='w/alfawDARL=640mol=100000Lamo=100000/z.dat')
		end if
