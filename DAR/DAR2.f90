module globalDAR
	...
	subroutine arquivos !!arquivos que aparecerão
		...
		if(L==768) then
			open(1,file='perfilDARL=768mol=100000Lamo=100000.dat')
			open(2,file='wDARL=768mol=100000Lamo=100000.dat')
		else if(L==896) then
			open(1,file='perfilDARL=896mol=100000Lamo=100000.dat')
			open(2,file='wDARL=896mol=100000Lamo=100000.dat')
		else if(L==1024) then
			open(1,file='perfilDARL=1024mol=100000Lamo=100000.dat')
			open(2,file='wDARL=1024mol=100000Lamo=100000.dat')
		else if(L==1152) then
			open(1,file='perfilDARL=1152mol=100000Lamo=100000.dat')
			open(2,file='wDARL=1152mol=100000Lamo=100000.dat')
		else if(L==1280) then
			open(1,file='perfilDARL=1280mol=100000Lamo=100000.dat')
			open(2,file='wDARL=1280mol=100000Lamo=100000.dat')
		end if
