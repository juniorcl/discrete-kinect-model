module globalDAR
	...
	real(8)::b,h,z
	real(8),parameter::expoz=2.0713
	real(8),parameter::expoalfa=0.5006
	...
	subroutine arquivos !!arquivos que aparecerão
		...
		if(L==128) then					
			!open(1,file='perfilDARL=128mol=100000Lamo=100000().dat')
			open(2,file='ajustado_DARL=128mol=100000Lamo=100000t.dat')
		else if(L==256) then
			!open(1,file='perfilDARL=256mol=100000Lamo=100000.dat')
			open(2,file='ajustado_DARL=256mol=100000Lamo=1000000.dat')
		else if(L==384) then
			!open(1,file='perfilDARL=384mol=100000Lamo=1000000.dat')
			open(2,file='ajustado_DARL=384mol=100000Lamo=1000000.dat')
		else if(L==512) then
			!open(1,file='perfilDARL=512mol=100000Lamo=1000000.dat')
			open(2,file='ajustado_DARL=512mol=100000Lamo=100000.dat')
		else if(L==640) then
			!open(1,file='perfilDARL=640mol=100000Lamo=1000000.dat')
			open(2,file='ajustado_DARL=640mol=100000Lamo=100000.dat')
		end if
...
!================================================================================================!	
	subroutine dados !!armazenamento dos dados
		...
		k=1
       		do n=1, mol/L   
                	if(n==k) then
	        		write(2,*) (n/(L**expoz)), (W(n)/(L**expoalfa))
                	k=int(k*m)+1
                	end if
		end do
		!***********************************!
